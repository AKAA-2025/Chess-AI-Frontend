        ...
        <div className={`relative max-w-7xl mx-auto px-6 py-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="text-center space-y-6 mb-12">
            ...
            <div className="flex gap-4 justify-center items-center pt-4">
              <button className="group relative px-8 py-4 bg-linear-to-r from-[#6B0D00] to-[#8B1000] text-white rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
              ...
              <button className="px-8 py-4 border-2 border-[#6B0D00] text-[#6B0D00] rounded-xl font-semibold text-lg hover:bg-[#6B0D00] hover:text-white transition-all duration-300">
                View Demo
              </button>
            </div>
