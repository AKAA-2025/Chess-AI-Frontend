...
import { Clock, Flag, MessageSquare, User, Cpu, TrendingDown, Trophy, Target, Zap, BarChart3 } from 'lucide-react';
...
const ChessGameplay = () => {
  ...
  // Generate performance data from move history
  ...
  return (
    <div className="min-h-screen bg-linear-to-r from-[#6B0D00]/5 to-transparent py-8 px-4">
      <div className="max-w-7xl mx-auto">
              ...
              <div className="flex justify-between items-center mt-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">ELO: 1500</div>
                  </div>
                </div>
        ...
        {gameOver && performanceData.length > 0 && (
